...
namespace GenAlgorithm5lab
{
    public class Devis
    {
        ...
        public static string Show(int personCount, int tMax, int krosChanse, int omChanse, int oiChanse)
        {
            ...
            var t = 0;
            _textOut+="____________________"+Environment.NewLine;
            _textOut+="step: " + t+Environment.NewLine;
        ...
        private static void GetKriteriySelection(List<List<int>> population)
        {
            ...
            _textOut += "avg: " + _populationFunctionValue.Average(p => p) + Environment.NewLine;
